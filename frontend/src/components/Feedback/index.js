...
function Feedback() {
  ...
  return (
    <div className="d-flex justify-content-center align-items-center feedback vh-100" style={{ width: '100%' }}>
      <div className="bg-white p-3 rounded w-100" style={{ maxWidth: '600px' }}>
        <h2>Get In Touch</h2>
        <form ref={form} onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            ...
            <input type="text" name="message" className="form-control rounded-0 large-input" />
          </div>
